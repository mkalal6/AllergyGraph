...
public class allergy_graph extends AppCompatActivity {
    ...
    int categoryOne_red = 68;
    int categoryOne_green = 114;
    int categoryOne_blue = 196;

    // Define area colors for category 2
    int categoryTwo_red = 237;
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.allergy_graph);
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            // In landscape
            mv.setImageResource(R.drawable.allergy_graph);
        } else {
            // In portrait
            mv.setImageResource(R.drawable.allergy_graph);
        }
...
//                grtv.setText("You swiped up with " + fingers + " finger(s).");
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(allergy_graph.this, GraphSelector.class);
    ...
    public void logger(String file_name) throws IOException {
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (ContextCompat.checkSelfPermission(allergy_graph.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(allergy_graph.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }
                else {
